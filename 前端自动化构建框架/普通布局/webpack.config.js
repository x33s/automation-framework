...
var config = {
    entry: {
        vendor: ['jquery','vue','./src/js/common/wap.plugins'],
        index: ['./src/js/index/index'],
        createEggSuccess: ['./src/js/createEggSuccess/index'],
        getPrize: ['./src/js/getPrize/index'],
        guessCorrect: ['./src/js/guessCorrect/index'],
        guessEgg: ['./src/js/guessEgg/index'],
        guessWrong: ['./src/js/guessWrong/index'],
    },
    output: {
